...
export default async function ProductPage({ params }: ProductPageProps) {
  try {
    ...
    const shuffleColorArray = shuffleArray(colorProducts);
    const shuffleCategoryArray = shuffleArray(categoryProducts);
    const shuffleOccassionArray = shuffleArray(occassionProducts);

    return (
      <ProductInsightPage
        product={product}
        Colorproduct={shuffleColorArray}
        Categoryproduct={shuffleCategoryArray}
        Occassionproduct={shuffleOccassionArray}
      />
    );
  } catch (error) {

...
const DescriptionTab = ({ product }) => {
  ...
  const description = [
    ...
    { key: "Occasion", value: product.occassions ? product.occassions?.map((occ) => occ.occasion.name).join(", ") : null },
  ...
  return (
    <div className="relative flex flex-col md:flex-row">
      ...
      <div className="w-full flex md:block gap-4 md:w-1/4 border-b md:border-b-0 md:border-r border-gray-200 md:pr-4">
        <div
          className={`cursor-pointer p-2 hover:text-[#533265] font-bold ${
            selectedCategory === 1 ? "text-[#533265]" : ""
          }`}
        ...
        <div
          className={`cursor-pointer p-2 hover:text-[#533265] font-bold ${
            selectedCategory === 2 ? "text-[#533265]" : ""
          }`}
        ...
        <div
          className={`cursor-pointer p-2 hover:text-[#533265] font-bold ${
            selectedCategory === 3 ? "text-[#533265]" : ""
          }`}

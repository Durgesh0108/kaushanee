      ...
      <div className="hidden md:flex">
        <div className="grid grid-cols-8 container">
          ...
          <div className="col-span-6 p-4">
            <div className="flex items-center justify-between sticky top-[6.5rem] z-40 bg-white font">
              <h1 className="text-3xl font-semibold m-4 ml-0 uppercase px-4 text-[#533265]">
                {Types?.name}
              </h1>
            </div>

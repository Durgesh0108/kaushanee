...
import prismadb from "@/lib/prisma";
import DressStyleComponent from "./_component/DressStyle";
import ShopByFabric from "./_component/Fabric";
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  const isSareeCategory = categories.some(
    (category) => category.name === "Saree"
  );

  return (
    <>
      <div className="no-scrollbar z-10 my-12 flex flex-col gap-y-12 ">
        {/* <div> */}
        <ShopByFabric fabric={fabric} />
        <ShopByCategory types={types} />

...
export default function Navbar({ products, categories, users, cart }) {
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#533265] container  py-4 hidden lg:grid grid-cols-12 items-center">
          ...
          <div className="flex gap-8 items-center p-2 text-xl">
            {categories.map((category, index) => (
              <div className="group flex flex-col items-center " key={index}>
                ...
                ></div>
                <div className="absolute z-50 group-hover:flex flex-col top-[2.4rem] left-0 w-full bg-[#533265] text-white py-1 px-4  shadow-xl hidden">
            ...
            <div className="group flex flex-col items-center text-white cursor-pointer">
              ...
              <div
                className={`duration-300 w-0 group-hover:w-full rounded-full border-b-[1px] border-b-[#dcb06a]`}
              ></div>
              <div className="absolute z-50 top-[2.4rem] left-0 w-full bg-[#533265] text-white pt-8 pb-4 px-4 shadow-xl hidden group-hover:block">
                <h1>What is Silk?</h1>
                <p>
          ...
          <div className="flex gap-8 items-center p-2 text-xl">
            {categories.map((category, index) => (
              <div
                ...
                key={index}
              >
                <div className="text-white group-hover:text-[#dcb06a] duration-300">
                  <Link href={`/category/${category.id}`}>{category.name}</Link>
                </div>
                <div
                  className={`duration-300 w-0 group-hover:w-full rounded-full border-b-[1px] border-b-[#dcb06a]`}
                ...
                <div className="absolute z-50 top-[1.8rem] left-0  bg-[#533265] text-white shadow-xl hidden group-hover:flex flex-col ">
                  <DropdownMenu Fabrics={category.Fabric} />
                </div>
              </div>
            ))}
            <div className="group flex flex-col items-center cursor-pointer">
              <Link
                href={"/styling"}
                className="text-white hover:text-[#dcb06a] duration-300"
              >
                Styles
              </Link>
              <div className="duration-300 w-0 group-hover:w-full rounded-full border-b-[1px] border-b-[#dcb06a]"></div>
            </div>
            ...
            <div className="group flex flex-col items-center cursor-pointer">
              <div className="text-white hover:text-[#dcb06a] duration-300">
                Sales
              </div>
              <div className="duration-300 w-0 group-hover:w-full rounded-full border-b-[1px] border-b-[#dcb06a]"></div>
            </div>

...
const NewArrivalSection = ({ products }) => {
  ...
  useEffect(() => {
    if (products.length > 0) {
      // Shuffle products array on component mount or reload
      ...
      <div className="container mx-auto px-4 sm:px-8">
        ...
        {shuffledProducts.length > 0 ? (
          <Swiper
            ...
            className="w-full "
          >
            {shuffledProducts.map((property, index) => (
                ...
                >
                  <div className="relative rounded-tl-2xl rounded-br-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                    ...
                    <div className="p-2 text-center">
                      <h1 className="text-base md:text-xl  line-clamp-1">
                        {property.name}
                      </h1>
                      <p className="text-sm md:text-lg font-bold line-clamp-1">
                        &#8377; {property.price}
                      </p>
                    </div>
                  </div>

    ...
    <div className="">
      <div className="container mx-auto px-4 sm:px-8">
        <div className="shadow-xl rounded-tl-3xl rounded-br-3xl p-8 md:p-16 bg-white flex flex-col   items-center">
          ...
          <div className="flex justify-center items-center mb-8 w-1/4">
            <Image
              src={
                "https://res.cloudinary.com/dbeuowl0x/image/upload/v1729232953/silk_mark_flesdk.png"
              }
              alt="Silkmark"
              // layout="responsive"
              width={200}
            ...
            <Image
              src={
                "https://res.cloudinary.com/dbeuowl0x/image/upload/v1729232953/handloom_ouwkxi.png"
              }
              alt="Silkmark"
              // layout="responsive"
              width={200}
            ...
            <Image
              src={
                "https://res.cloudinary.com/dbeuowl0x/image/upload/v1729232953/khadi-india_t6kmg3.png"
              }
              alt="Silkmark"
              // layout="responsive"
              width={200}
